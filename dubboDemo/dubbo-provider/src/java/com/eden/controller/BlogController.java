...
public class BlogController {
    ...
    public String showBlogs(ModelMap modelMap) {
        ...
        List<model.BlogEntity> blogList = blogRepository.findAll();
    ...
    public String addBlogPost(@ModelAttribute("blog") model.BlogEntity blogEntity) {
        // 打印博客标题
    ...
    public String showBlog(@PathVariable("id") int id, ModelMap modelMap) {
        model.BlogEntity blog = blogRepository.findOne(id);
    ...
    public String updateBlogP(@ModelAttribute("blogP") model.BlogEntity blogEntity) {
        // 更新博客信息
